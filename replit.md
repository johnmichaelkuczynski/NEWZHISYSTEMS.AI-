...
- **Authentication: NONE (reconfirmed by owner's order 2026-08-27)**: Do not install or restore Google OAuth, Clerk, sessions, password gates, login screens, or auth middleware unless the owner explicitly requests it. Every existing site tab and API is intentionally public. The Administrative analytics feature was removed.
