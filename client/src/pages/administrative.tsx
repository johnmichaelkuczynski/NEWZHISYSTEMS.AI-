    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {statCards.map((s) => (
            <div key={s.label} className="bg-white border border-gray-200 rounded-lg p-4 text-center">
              ...
              <div className="text-gray-600 text-sm mt-1">{s.label} Visits</div>
            </div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <VisitChart title="Last Month (by day)" data={buildSeries(visits, 30 * 86_400_000, "day")} />
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-3">Visit Log</h2>
        {visits.length === 0 ? (
